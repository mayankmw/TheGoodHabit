...
const handleRemoveCoupon = async (cartCouponId: number) => {
  ...
  // small helper: cursor-friendly price formatting
          ...
          <div className="flex items-center justify-between h-16 relative">
                        ...
                        {submenuOpen && (
                          <div className="pl-3 mt-3 grid grid-cols-2 gap-3">
                            {categories.map((cat) => (
                              ...
                              >
                                <img src={cat.image} alt={cat.name} className="w-20 h-20 object-cover rounded-lg shadow-2xl" />
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
              <a href="/" className="block">
                <img src="/images/logo/logo2.png" alt="Logo" className="h-20 w-25 object-contain drop-shadow-md" />
              </a>
            </div>
